...
topologia        <- 30 #PARAMETRO DEL TIPO c(A,B,C,...,X) A SIENDO LAS NEURONAS EN LA CAPA OCULTA 1, B LA CAPA 2 ...
razonAprendizaje <- 0.1 #NUMERO REAL ENTRE 0 y 1
ciclosMaximos    <- 100 #NUMERO ENTERO MAYOR QUE 0



# for(topologia in c(10 30 50 70)){
#     for (razonAprendizaje in c(0.01, 0.02, 0.05, 0.25, 0.5, 0.7, 0.9)){
...
# # 
 ...
 antiguosCiclos <- read.csv2('ciclosOptimos.csv',dec=".",sep=",",header = F)
 write.csv2(nuevosCiclos+antiguosCiclos, 'ciclosOptimos.csv')
